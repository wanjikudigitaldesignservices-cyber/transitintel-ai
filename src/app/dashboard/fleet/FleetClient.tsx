        ...
        <div className="mb-4 flex flex-wrap items-center justify-between border-b border-white/10 pb-4 gap-2">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="btn-secondary py-1.5 px-3 text-xs flex items-center gap-1.5 bg-brand-600/30 hover:bg-brand-600/50 border-brand-500/40 text-brand-300 rounded-lg cursor-pointer transition-all"
            >
            ...
            <button onClick={onClose} className="btn-ghost rounded-lg p-2 hover:bg-white/10 text-white/70">
