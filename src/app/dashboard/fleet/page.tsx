...
// Demo fleet data
const vehicles = [
  { id: "v1", registrationNo: "KBX 234R", fleetNumber: "F001", make: "Isuzu", model: "NQR", year: 2022, type: "BUS", capacity: 51, fuelType: "DIESEL", status: "ACTIVE", mileage: 124500, lastService: "2024-12-15" },
  { id: "v2", registrationNo: "KCA 891J", fleetNumber: "F002", make: "Toyota", model: "Coaster", year: 2023, type: "MINIBUS", capacity: 29, fuelType: "DIESEL", status: "ACTIVE", mileage: 89200, lastService: "2025-01-20" },
  { id: "v3", registrationNo: "KDA 102K", fleetNumber: "F003", make: "Scania", model: "K360", year: 2021, type: "COACH", capacity: 65, fuelType: "DIESEL", status: "MAINTENANCE", mileage: 210300, lastService: "2024-11-05" },
  { id: "v4", registrationNo: "KBZ 456T", fleetNumber: "F004", make: "Mercedes", model: "Sprinter", year: 2023, type: "SHUTTLE", capacity: 18, fuelType: "DIESEL", status: "ACTIVE", mileage: 67800, lastService: "2025-02-10" },
  { id: "v5", registrationNo: "KCB 789P", fleetNumber: "F005", make: "Nissan", model: "Civilian", year: 2020, type: "MATATU", capacity: 33, fuelType: "DIESEL", status: "ACTIVE", mileage: 178900, lastService: "2024-10-28" },
  { id: "v6", registrationNo: "KDD 321M", fleetNumber: "F006", make: "BYD", model: "K9", year: 2024, type: "BUS", capacity: 45, fuelType: "ELECTRIC", status: "ACTIVE", mileage: 23400, lastService: "2025-03-01" },
  { id: "v7", registrationNo: "KAZ 654Q", fleetNumber: "F007", make: "Isuzu", model: "FRR", year: 2019, type: "BUS", capacity: 51, fuelType: "DIESEL", status: "SUSPENDED", mileage: 298700, lastService: "2024-08-15" },
  { id: "v8", registrationNo: "KBC 987S", fleetNumber: "F008", make: "Toyota", model: "HiAce", year: 2022, type: "VAN", capacity: 14, fuelType: "PETROL", status: "ACTIVE", mileage: 95600, lastService: "2025-01-08" },
  { id: "v9", registrationNo: "KCE 111L", fleetNumber: "F009", make: "Zhongtong", model: "LCK6125", year: 2023, type: "COACH", capacity: 55, fuelType: "DIESEL", status: "INACTIVE", mileage: 45200, lastService: "2025-02-22" },
  { id: "v10", registrationNo: "KDB 222N", fleetNumber: "F010", make: "Isuzu", model: "NQR", year: 2024, type: "BUS", capacity: 51, fuelType: "DIESEL", status: "ACTIVE", mileage: 12300, lastService: "2025-03-15" },
];
...
export default function FleetPage() {
  ...
  const filtered = vehicles.filter((v) => {
    const matchSearch =
      ...
      v.fleetNumber.toLowerCase().includes(search.toLowerCase());
      ...
      <div className="glass-card overflow-hidden dark:border-white/5 dark:bg-white/[0.02]">
            ...
            <tbody>
              {filtered.map((vehicle) => (
                <tr key={vehicle.id}>
                  <td>
                    <div>
                      ...
                      <p className="text-xs text-surface-800/40 dark:text-white/30">
                        {vehicle.fleetNumber} · {vehicle.make} {vehicle.model} ({vehicle.year})
                      </p>
                    </div>
                  </td>
                  <td>
                  ...
                  <td>
                    <span className={`status-badge ${statusColors[vehicle.status] || ""}`}>
        ...
        <div className="flex items-center justify-between border-t border-surface-200 px-4 py-3 dark:border-white/5">
          <p className="text-sm text-surface-800/50 dark:text-white/40">
            ...
            <span className="font-semibold text-surface-900 dark:text-white">{vehicles.length}</span> vehicles
          </p>
